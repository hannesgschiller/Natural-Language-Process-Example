...
Load the Dataset
```{r}
test= read.csv("/Users/owner/Documents/Capstone/drugsCom_raw/drugsComTest_raw_csv.csv")
train= read.csv("/Users/owner/Documents/Capstone/drugsCom_raw/drugsComTrain_raw_csv.csv")
```
